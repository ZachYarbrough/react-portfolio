    ...
    return (
        <FadeIn className='content'>
            ...
            <div>
                ...
                <p className='d-flex align-items-start'><span className='alert alert-primary mr-5 py-0 px-5'>2022</span> <span>Created a website for the client</span>
                    <Link to='/work/10k%20cards' aria-label="10k cards">
                        <span className='ml-5'>10k Cards</span>
                    </Link>
                </p>
